...
<div class="relative">
  {#if !showSuccessPopup}
    <Dialog open={true} onOpenChange={closeModal}>
      <DialogContent class="w-full max-w-[758px] !rounded-[59px] bg-white p-16 text-center shadow-sm max-md:px-5 max-md:py-24" >

        <header class="flex w-[266px] max-w-full flex-col font-semibold mx-auto">
        ...
        <section class="flex flex-col w-full mt-20 max-md:mt-10 max-md:max-w-full">
          <div class="flex min-h-[49px] w-full items-center gap-1 border-b border-black py-3.5 pl-4 pr-5 max-md:max-w-full max-md:pr-5">
            <div class="my-auto flex w-[551px] min-w-[240px] flex-wrap items-center justify-between gap-10 self-stretch">
