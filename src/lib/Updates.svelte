...
<div class="inline-flex flex-col items-start justify-start w-full p-4 bg-white md:p-9">
    <div class="flex flex-col items-start self-stretch justify-start gap-2">
        <div class="w-full pt-[1.75px] flex-col justify-start items-start gap-[13.30px] flex">
            <div class="self-stretch text-[#282828] text-2xl md:text-[32px] font-bold font-['Inter'] leading-tight md:leading-10">{update.title}</div>
                ...
                <div class="inline-flex items-center justify-start w-full gap-3">
                    ...
                    <div class="inline-flex flex-col justify-between w-full">
                        <div class="inline-flex items-center self-stretch gap-2">
                            <div class="text-[#282828] text-sm font-normal font-['Inter'] leading-normal truncate max-w-[200px] md:max-w-none">{update.userProfile.name}</div>
                        ...
                        <div class="self-stretch text-[#282828]/50 text-[13px] font-normal font-['Inter'] leading-[18px]">{date}</div>
                    </div>
                </div>
            </div>
        </div>
        <div class="flex flex-col items-start self-stretch justify-start gap-1">
            <div class="self-stretch pb-2 flex-col justify-start items-start gap-[30px] flex">
                <div class="self-stretch text-[#282828] text-base font-normal font-['Inter'] leading-relaxed">{@html truncatedContent}</div>
            </div>
        </div>
        <div class="inline-flex items-center justify-between w-full">
            <div class="flex items-center justify-start gap-6">
                <div class="flex items-center justify-start gap-2">
                    ...
                    <div class="text-[#9b9e9e] text-sm font-normal font-['Inter'] leading-normal">16</div>
                </div>
            </div>
            <button on:click={showDetail} class="px-4 md:px-[19px] py-2 md:py-[11.50px] bg-white border border-[#d1d1d1] justify-center items-center gap-1.5 flex">
                <div class="text-center text-[#222222] text-sm font-normal">Read more</div>
